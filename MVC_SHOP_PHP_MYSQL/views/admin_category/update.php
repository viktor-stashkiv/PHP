            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Статус</p>
                        <select name="status">
                            <option value="1" <?php if ($category['status'] == 1) echo ' selected="selected"'; ?>>Відобразити</option>
                            <option value="0" <?php if ($category['status'] == 0) echo ' selected="selected"'; ?>>Сховати</option>
                        </select>
